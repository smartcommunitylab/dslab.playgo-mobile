...
export class PlayerTeamControllerService {
   ...
   * @param txt txt
   */
  public candidatesUsingGET(args: {
    initiativeId: string;
    page: number;
    size: number;
    sort?: string;
   ...
   */
  public checkSubscribeTeamMemberUsingGET(args: {
    initiativeId: string;
    nickname: string;
  }): Observable<boolean> {
   ...
   * @param teamId teamId
   */
  public deleteTeamUsingDELETE(args: {
    initiativeId: string;
    teamId: string;
  }): Observable<any> {
   ...
   * @param teamId teamId
   */
  public getMyTeamInfoUsingGET(args: {
    initiativeId: string;
    teamId: string;
   ...
   * @param teamId teamId
   */
  public getPlayerTeamInfoUsingGET(args: {
    initiativeId: string;
    teamId: string;
   ...
   * @param teamId teamId
   */
  public getPublicTeamInfoUsingGET(args: {
    initiativeId: string;
    teamId: string;
  }): Observable<PlayerTeam> {
    const { initiativeId, teamId } = args;
   ...
   * @param body
   */
  public saveInitiativeUsingPUT(args: {
    initiativeId: string;
    body?: Initiative;
   ...
   * @param body
   */
  public uploadTeamAvatarUsingPOST(args: {
    teamId: string;
    body?: Object;
  }): Observable<Avatar> {
