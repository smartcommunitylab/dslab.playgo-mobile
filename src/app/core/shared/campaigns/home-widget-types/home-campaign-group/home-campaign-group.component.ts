...
@Component({
  selector: 'app-home-campaign-group',
  templateUrl: './home-campaign-group.component.html',
  styleUrls: ['./home-campaign-group.component.scss'],
  standalone:false

})
export class HomeCampaignGroupComponent implements OnInit, OnDestroy {
