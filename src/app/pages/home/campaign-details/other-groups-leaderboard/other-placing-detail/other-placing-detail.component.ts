...
@Component({
  selector: 'app-other-placing-detail',
  templateUrl: './other-placing-detail.component.html',
  styleUrls: ['./other-placing-detail.component.scss'],
  standalone: false
})
export class OtherPlacingDetailComponent implements OnInit {
  @Input()
